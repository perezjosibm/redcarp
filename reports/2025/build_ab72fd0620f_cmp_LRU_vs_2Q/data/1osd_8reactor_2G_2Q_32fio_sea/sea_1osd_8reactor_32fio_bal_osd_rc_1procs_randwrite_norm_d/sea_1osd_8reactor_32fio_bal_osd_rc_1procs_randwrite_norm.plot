...
set autoscale y
set autoscale y2
set output 'sea_1osd_8reactor_32fio_bal_osd_rc_1procs_randwrite_norm_iops_vs_lat_vs_cpu.png'
set title "sea-1osd-8reactor-32fio-bal-osd-rc-1procs"
plot 'sea_1osd_8reactor_32fio_bal_osd_rc_1procs_randwrite_norm.dat' index 0 using ($2/1e3):4:5 t '1 q-depth' w yerr axes x1y1 lc 1,\
